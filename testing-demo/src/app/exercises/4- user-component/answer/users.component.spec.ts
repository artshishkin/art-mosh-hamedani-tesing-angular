...
xdescribe('UsersComponent-answer', () => {
  let component: UsersComponent;
  let service: UserService;

  beforeEach(() => {
    service = new UserService(null as any);
  ...
  describe('When deleting a user', () => {
    ...
    it('should remove the selected user from the list if the user confirms deletion', () => {
      ...
      spyOn(service, 'deleteUser').and.returnValue(from([true]));
    ...
    it('should call the server to delete the selected user if the user confirms deletion', () => {
      spyOn(window, 'confirm').and.returnValue(true);
      let spy = spyOn(service, 'deleteUser').and.returnValue(from([true]));
